  ...
  <div>
    <div
      ...
      <div
        ...
        <lucide-menu @click="$emit('toggleSidebar')" v-if="!toggle" class="lg:hidden menu" />
        <lucide-x @click="$emit('toggleSidebar')" v-if="toggle" class="lg:hidden menu" />
        <p class="sm:text-lg">پنل مدیریتی کویر تریلر</p>
      </div>
      <div class="grow flex items-center justify-end">
        <div ref="logo" class="w-fit">
          <Logo class="h-12 md:h-[8vh] fill-sidecar" />
        </div>
      </div>
